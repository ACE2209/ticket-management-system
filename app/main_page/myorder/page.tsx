...
export default function MyOrderPage() {
  ...
  const upcomingEvents = listEventsData.slice(0, 2);
  const pastEvents = listEventsData.slice(2, 10);
          ...
          >
            ...
            <div className="flex flex-col justify-between flex-1">
              ...
              <div className="flex justify-between mt-3">
                <button
                  // ✅ Dùng đúng id trong data
                  onClick={() => router.push(`/main_page/myorder/${event.id}`)}
                ...
                <button
                  onClick={() => router.push(`/main_page/myticket/${event.id}`)}
