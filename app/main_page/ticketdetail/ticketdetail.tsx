...
export default function TicketDetailPage() {
  ...
  const area = event?.areas?.find((a) => a.name === areaParam);
  const ticket = area?.tickets.find((t) => t.id === ticketId);
          ...
          <div className="px-4 pt-4 pb-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-[12px] text-[#78828A]">
              <div>
                ...
                <div className="text-black font-medium">Jonatan Levian</div>
              </div>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-[12px] text-[#78828A]">
              ...
              <div className="text-right">
                <div>Seat</div>
                <div className="text-black font-medium">{ticket.id}</div>
              </div>
            </div>
            ...
            <div className="mt-6 bg-[#F6F8FE] rounded-md p-4">
              ...
              <p className="text-center text-[12px] text-[#111111] mt-3 font-medium">
                Scan the barcode
                <span className="text-[#78828A] ml-1">— {ticket.barcode}</span>
              </p>
            </div>
          </div>
        </div>
